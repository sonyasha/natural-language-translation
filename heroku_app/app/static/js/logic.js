$( document ).ready(function() {
    console.log( "Hey! Welcome to our website, here you can find a funny and upredictable translations of common words and phrases and also generate a unique Haiku. Hope you will enjoy it!" );
    $('.spa').addClass('active');
