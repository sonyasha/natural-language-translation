...
def maybe_download_and_extract(language_code="es"):
    """
    ...
    English and the given language-code (e.g. 'es' for Spanish, see the
...
def load_data(english=True, language_code="es", start="", end=""):
    """
